...
export const SiteSettingsProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const value: SiteSettingsContextType = {
    ...
    complaintsWhatsApp: settings.complaintsWhatsApp || settings.customerServiceWhatsApp || settings.whatsapp || DEFAULT_SITE_SETTINGS.complaintsWhatsApp || '01121778205',
    complaintsPhone: settings.complaintsPhone || settings.customerServicePhone || settings.phone || DEFAULT_SITE_SETTINGS.complaintsPhone || '01121778205',
...
export const useSiteSettings = (): SiteSettingsContextType => {
  ...
  if (!context) {
    ...
    return {
      ...
      complaintsWhatsApp: DEFAULT_SITE_SETTINGS.complaintsWhatsApp || DEFAULT_SITE_SETTINGS.whatsapp || '01121778205',
      complaintsPhone: DEFAULT_SITE_SETTINGS.complaintsPhone || DEFAULT_SITE_SETTINGS.phone || '01121778205',
