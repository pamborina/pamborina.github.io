    ...
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/80 backdrop-blur-sm flex items-center justify-center p-2 sm:p-4" dir="rtl">
      <div className="bg-neutral-900 border border-neutral-800 rounded-2xl w-full max-w-2xl shadow-2xl overflow-hidden flex flex-col max-h-[92vh] max-h-[92dvh] my-auto">
        ...
        <form
          ...
          onSubmit={handleSave}
          className="p-4 sm:p-6 overflow-y-auto space-y-4 sm:space-y-6 flex-1 text-xs sm:text-sm text-neutral-200 custom-scrollbar"
        >
          {error && (
        ...
        {/* Modal Footer */}
        <div className="px-4 sm:px-6 py-3.5 sm:py-4 border-t border-neutral-800 bg-neutral-900/95 flex items-center justify-between gap-3 shrink-0">
          <Button
            type="button"
            variant="outline"
            onClick={onClose}
            disabled={loading}
            className="border-neutral-700 text-neutral-300 hover:bg-neutral-800 rounded-xl px-4 py-2 text-xs sm:text-sm"
          >
            إلغاء
          </Button>
          ...
          <Button
            ...
            className="bg-amber-500 hover:bg-amber-600 text-neutral-950 font-black px-6 py-2 rounded-xl flex items-center gap-2 text-xs sm:text-sm shadow-lg shadow-amber-500/20 cursor-pointer active:scale-95 transition-all"
          >
