  ...
  return (
    <>
      ...
      <div className="bg-neutral-900 border border-neutral-700/90 rounded-3xl w-full max-w-5xl max-h-[92vh] flex flex-col shadow-2xl overflow-hidden">
        {/* Header */}
        <div className="p-5 sm:p-6 bg-gradient-to-r from-neutral-800 via-neutral-850 to-neutral-900 border-b border-neutral-700/80 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              type="button"
              onClick={handlePrint}
              className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-neutral-800 hover:bg-neutral-700 text-white text-xs font-bold border border-neutral-600 transition-all cursor-pointer shadow-sm hover:border-amber-500/50"
            ...
            <button
              type="button"
              onClick={onClose}
              className="w-10 h-10 rounded-xl bg-neutral-800/80 hover:bg-rose-500/20 text-neutral-400 hover:text-rose-300 border border-neutral-700 flex items-center justify-center transition-all cursor-pointer"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
        ...
        <div className="px-5 sm:px-6 py-4 bg-neutral-850 border-b border-neutral-800 flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-1.5 bg-neutral-900/90 p-1 rounded-xl border border-neutral-750">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            <div className="relative flex-1 sm:w-56">
              ...
              <input
                ...
                className="w-full bg-neutral-900 border border-neutral-750 rounded-xl py-1.5 pr-8 pl-3 text-xs text-white placeholder-neutral-500 focus:outline-none focus:border-amber-500/60"
              />
            </div>
            ...
            <div className="flex items-center gap-1 bg-neutral-900/90 p-1 rounded-xl border border-neutral-750">
              <button
                ...
                className={`px-2.5 py-1 rounded-lg text-[11px] font-bold cursor-pointer ${
                  statusFilter === 'all' ? 'bg-neutral-700 text-white' : 'text-neutral-400 hover:text-white'
                }`}
              >
                الكل
              </button>
              ...
              <button
                ...
                className={`px-2.5 py-1 rounded-lg text-[11px] font-bold cursor-pointer ${
                  statusFilter === 'inactive' ? 'bg-rose-600 text-white' : 'text-neutral-400 hover:text-white'
                }`}
              >
                معطل
              </button>
        ...
        {/* KPI Cards Row */}
        <div className="p-5 sm:p-6 grid grid-cols-2 md:grid-cols-4 gap-3.5 bg-neutral-900/50">
          ...
          <div className="bg-gradient-to-br from-emerald-950/30 to-neutral-800/90 border border-emerald-500/30 rounded-2xl p-4 shadow-md">
            <div className="flex items-center justify-between text-emerald-400 text-xs mb-1">
              <span className="font-bold">إجمالي رسوم التوصيل المحققة</span>
              <DollarSign className="w-4 h-4 text-emerald-400" />
            </div>
            <div className="text-2xl sm:text-3xl font-black text-emerald-400 font-mono">
              {totalDeliveryFeesCollected.toLocaleString('en-US')} <span className="text-xs font-bold">ج.م</span>
            </div>
            <div className="text-[10px] text-emerald-300/80 mt-1">سعر التوصيل فقط (بدون أسعار المنتجات)</div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-5">
          ...
          <div className="bg-neutral-800/70 border border-neutral-700/80 rounded-2xl overflow-hidden shadow-lg">
            <div className="px-4 py-3 bg-neutral-800 border-b border-neutral-700/80 flex items-center justify-between">
