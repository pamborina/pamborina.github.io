...
export const EditDeliveryFeeModal: React.FC<EditDeliveryFeeModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/80 backdrop-blur-sm dir-rtl">
      <div className="bg-[#18110B] border border-[#D4AF37]/40 rounded-3xl p-5 sm:p-6 max-w-lg w-full text-[#FFF1C5] space-y-5 shadow-[0_20px_50px_rgba(0,0,0,0.9)] max-h-[92vh] overflow-y-auto scrollbar-thin scrollbar-thumb-[#3D2C1E] animate-in fade-in zoom-in-95">
        {/* Header */}
