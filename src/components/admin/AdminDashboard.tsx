...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  const allNavItems: {
    ...
    { id: 'overview', label: 'الرئيسية', icon: <LayoutDashboard className="w-5 h-5" />, permission: 'analytics.view' },
              ...
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2">
                ...
                <span className="flex items-center gap-1.5">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-[#1C140E] hover:bg-[#2A1E14] border border-[#D4AF37]/50 hover:border-[#D4AF37] text-[#F4E08B] hover:text-[#FFF1C5] font-bold text-xs shadow-sm transition-all duration-150 hover:scale-105 active:scale-95 group cursor-pointer"
