                  ...
                  {(() => {
                    ...
                    return (
                      <div className="p-4 rounded-2xl bg-gradient-to-b from-[#22160E] to-[#170E08] border-2 border-[#D4AF37] shadow-[0_0_25px_rgba(212,175,55,0.2)] text-right space-y-3">
                        ...
                        {/* Delivery fee note */}
                        {orderType === 'delivery' && (
                          <div className="p-3.5 rounded-2xl bg-gradient-to-br from-[#26170D] to-[#170E08] border border-amber-500/40 text-xs text-[#E8DAC8] space-y-1.5 shadow-sm">
                            <div className="flex items-center gap-2 text-[#F4E08B] font-bold">
                              <Truck className="w-4 h-4 text-amber-400 shrink-0" />
                              <span>رسوم التوصيل (تُحدد فوراً من قِبل الإدارة):</span>
                            </div>
                            <p className="text-[11px] leading-relaxed text-[#FFF1C5]/90 pr-6 font-medium">
                              يتم تحديد رسوم التوصيل بدقة من قِبل الإدارة وتنعكس مباشرةً وتلقائياً على فاتورتك في شاشة <span className="text-[#F4E08B] font-bold underline">«تتبع الطلب»</span> بمجرد استلام طلبك ومراجعة العنوان ⚡
                            </p>
                          </div>
                        )}
                      </div>
                        ...
                        {orderType === 'delivery' && isEffectiveDeliveryAvailable && (
                          <div className="p-3 rounded-2xl bg-[#1C120A] border border-amber-500/30 text-amber-200 text-xs flex items-center gap-2.5">
                            ...
                            <span className="leading-relaxed font-medium">
                              يتم تحديد رسوم التوصيل من قِبل الإدارة وتنعكس مباشرةً على فاتورتك في خانة <strong className="text-[#F4E08B]">«تتبع الطلب»</strong> فور استلام الطلب.
                            </span>
                          </div>
                        )}
                    ...
                    <div className="space-y-3 pt-2 border-t border-[#2C1F16]">
                      {orderType === 'delivery' ? (
                        <>
                          ...
                          <div className="p-3.5 rounded-2xl bg-gradient-to-r from-[#26170E] to-[#1C120A] border border-[#D4AF37]/45 text-[#F4E08B] text-xs flex items-start gap-2.5 shadow-md">
                            <Truck className="w-4 h-4 text-[#D4AF37] shrink-0 mt-0.5" />
                            <div className="space-y-1 text-right">
                              <span className="font-black text-[#FFF1C5] block">
                                💡 رسوم التوصيل:
                              </span>
                              <p className="leading-relaxed text-[#E8DAC8] text-[11px] font-medium">
                                يتم تحديد رسوم التوصيل بدقة من قِبل الإدارة بناءً على العنوان، وتظهر وتنعكس مباشرةً على فاتورتك في خانة <span className="text-[#F4E08B] font-bold underline">«تتبع الطلب»</span> بمجرد استلام الطلب وبدء تجهيزه.
                              </p>
                            </div>
                          </div>
