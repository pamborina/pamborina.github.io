        ...
        {categories.map((category, idx) => {
          ...
          return (
            ...
            >
              ...
              {/* Top Row: Category Thumbnail Image / Icon Badge & Item Count */}
              <div className="relative z-10 flex items-center justify-between gap-1.5">
                <div
                  className={`w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl flex items-center justify-center shrink-0 transition-all duration-300 shadow-md overflow-hidden ${
                    isSelected
                      ? 'bg-gradient-to-r from-[#D4AF37] via-[#F4E08B] to-[#D4AF37] text-black ring-2 ring-[#D4AF37] shadow-[0_0_14px_rgba(212,175,55,0.6)]'
