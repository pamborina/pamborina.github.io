...
import { Input, SearchInput, Select, Stepper, RadioGroup, PasswordInput } from '../ui/Input';
        ...
        <section className="space-y-8">
          ...
          <Card className="p-6 space-y-6 bg-[#140E0A] border-[#3D2C1E]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Input
                label="كلمة المرور (Input القياسي)"
                type="password"
                placeholder="••••••••"
                floatingLabel
              />
              ...
              <PasswordInput
                label="كلمة المرور الموحدة (PasswordInput المتطور)"
