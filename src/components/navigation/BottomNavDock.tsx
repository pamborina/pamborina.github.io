...
import { Home, UtensilsCrossed, ShoppingBag, MapPin, Film, LucideIcon } from 'lucide-react';
        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`relative flex-1 flex flex-col items-center justify-center py-1.5 px-1 rounded-2xl min-h-[48px] transition-all duration-200 cursor-pointer active:scale-95 select-none ${
