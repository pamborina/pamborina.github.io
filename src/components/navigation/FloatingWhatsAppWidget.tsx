...
export const FloatingWhatsAppWidget: React.FC = () => {
    ...
    const fallbackList: ContactNumberItem[] = [
      {
        ...
        phoneNumber: customerServiceWhatsApp || whatsapp || '01112624108',
        defaultMessageAr:
      ...
      },
      {
        ...
        phoneNumber: complaintsWhatsApp || customerServiceWhatsApp || whatsapp || '01112624108',
        defaultMessageAr:
  ...
  const handleCopy = async (id: string, phoneNum: string) => {
    await copyToClipboard(phoneNum);
    setCopiedId(id);
    setTimeout(() => {
      setCopiedId(null);
    }, 2000);
