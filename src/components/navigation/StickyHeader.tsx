...
import { MapPin, Search, Bell, ChevronDown, Sparkles, ShoppingBag, Home, UtensilsCrossed, Store, Truck, Film, Package } from 'lucide-react';
...
export const StickyHeader: React.FC<StickyHeaderProps> = ({
  ...
  return (
    <header
      ref={headerRef}
      className="sticky top-0 z-40 w-full bg-[#140E0A]/95 backdrop-blur-xl border-b border-[#D4AF37]/25 shadow-xl dir-rtl"
    >
