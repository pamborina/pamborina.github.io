    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          onClick={scrollToTop}
          className="fixed bottom-20 sm:bottom-24 md:bottom-8 right-3.5 sm:right-6 md:right-8 z-40 flex items-center justify-center w-11 h-11 sm:w-13 sm:h-13 rounded-full bg-gradient-to-tr from-[#D4AF37] via-[#F4E08B] to-[#D4AF37] text-[#1A1008] border border-[#FFF1C5]/70 shadow-2xl shadow-[#D4AF37]/50 cursor-pointer focus:outline-none select-none group"
