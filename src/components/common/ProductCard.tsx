      ...
      <div className="p-4 pt-2 border-t border-[#2C1F16] bg-[#120B07] rounded-b-3xl flex items-center justify-between gap-3">
        ...
        {!isStoreOpen ? (
          <button
            ...
            className="min-h-[40px] px-3.5 py-2 sm:px-4 sm:py-2.5 rounded-2xl font-black text-xs bg-rose-950/90 text-rose-300 border border-rose-500/50 hover:bg-rose-900 transition-all flex items-center justify-center gap-1.5 cursor-pointer shadow-md whitespace-nowrap shrink-0 select-none"
          >
          ...
          <button
            type="button"
            disabled
            className="min-h-[40px] px-3.5 py-2 sm:px-4 sm:py-2.5 rounded-2xl font-bold text-xs bg-neutral-800/90 text-neutral-400 border border-neutral-700/80 cursor-not-allowed flex items-center justify-center gap-1.5 opacity-90 whitespace-nowrap shrink-0 select-none"
          >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.94 }}
            onClick={handleAddClick}
            className={`relative min-h-[40px] px-3.5 py-2 sm:px-5 sm:py-2.5 rounded-2xl font-black text-xs sm:text-sm shadow-xl transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer whitespace-nowrap shrink-0 select-none ${
              isAdded
                ? 'bg-emerald-500 text-neutral-950 shadow-emerald-500/40 ring-2 ring-emerald-400'
                : 'bg-gradient-to-r from-[#D4AF37] via-[#F4E08B] to-[#D4AF37] text-neutral-950 shadow-[0_4px_20px_rgba(212,175,55,0.4)] hover:brightness-110 active:scale-95'
            }`}
          >
            <AnimatePresence mode="wait">
              {isAdded ? (
                ...
                <motion.div
                  ...
                  className="flex items-center gap-1.5 whitespace-nowrap"
                >
                  <ShoppingBag className="w-4 h-4 text-neutral-950 stroke-[2.5] shrink-0" />
