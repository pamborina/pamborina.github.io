        ...
        <div className="relative flex items-center">
          ...
          {isPassword && (
            <button
              ...
              className="absolute left-2.5 my-auto h-8 w-8 rounded-lg flex items-center justify-center text-[#8E8373] hover:text-[#D4AF37] focus:text-[#D4AF37] focus:outline-none focus:ring-1 focus:ring-[#D4AF37]/50 transition-colors cursor-pointer"
            >
