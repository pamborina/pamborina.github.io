...
export const DEFAULT_CONTACT_CHANNELS: ContactNumberItem[] = [
  {
    ...
    phoneNumber: STORE_CONFIG.whatsappCleanNumber || '01121778205',
...
export const DEFAULT_SITE_SETTINGS: SiteSettings = {
  ...
  complaintsWhatsApp: STORE_CONFIG.whatsappPrimary || '01121778205',
  complaintsPhone: STORE_CONFIG.hotline || '01121778205',
